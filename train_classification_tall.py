...
for gt_0_class in gt_0_classes:
    ...
    best_valLoss = 9999
    num_epochs = 200
    txtpath = f'./ablation/tall/xray/train_ablation_xray_subdataset{n}.txt'
    txtpath2 = f'./ablation/tall/xray/val_ablation_xray_subdataset{n}.txt'
    ...
    def saveModel():
        path = f"./ablation/tall/xray/model_ablation_xray_subdataset{n}.pth"
    ...
    for epoch in range(num_epochs):
        ...
        ff.flush()
    np.save(f'./ablation/tall/xray/tall_model_{n}_train_metrics_ablation_xray.npy', train_metrics_history)
    np.save(f'./ablation/tall/xray/tall_model_{n}_val_metrics_ablation_xray.npy', val_metrics_history)
