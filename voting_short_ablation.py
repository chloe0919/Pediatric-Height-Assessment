...
modelpath = './ablation/short/xray+gender/'
...
# 繪製10個基礎模型的ROC
for i in range(1, 11):
   metrics = np.load(f'./ablation/short/xray+gender/short_model_{i}_val_metrics_ablation_xray_gender.npy', allow_pickle=True)
...
plt.grid(True)
plt.savefig("./ablation/short/xray+gender/ROC_short_xray+gender.png")
plt.show()
...
plt.savefig("./ablation/short/xray+gender/voting_cm_short_xray+gender.png")
plt.show()