...
modelpath = './model_pth_tall/'
pattern = modelpath + 'allmatrics_train_outliers_gender_60days_subdataset*.pth'
...
# 繪製10個基礎模型的ROC
for i in range(1, 11):
   metrics = np.load(f'./matrics/tall_model_{i}_val_metrics_age.npy', allow_pickle=True)
...
plt.grid(True)
# plt.savefig("ROC_tall_softvoting_ablation_xray.png")
plt.show()
...
# plt.savefig("voting_cm_tall_ablation_xray.png")
plt.show()