...
for gt_0_class in gt_0_classes:
    ...
    best_valLoss = 9999
    num_epochs = 200
    txtpath = f'./result_train_short/train_revision1217_subdataset{n}.txt'
    txtpath2 = f'./result_val_short/val_revision1217_xray_subdataset{n}.txt'
    ...
    def saveModel():
        path = f"./model_pth_short/model_revision1217_subdataset{n}.pth"
    ...
    for epoch in range(num_epochs):
        ...
        ff.flush()
    np.save(f'matrics/model_{n}_train_metrics_revision1217.npy', train_metrics_history)
    np.save(f'matrics/model_{n}_val_metrics_revision1217.npy', val_metrics_history)
